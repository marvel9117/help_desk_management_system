...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2022 at 07:52 AM
...
INSERT INTO `administrators` (`id`, `first_name`, `surname`, `other_name`, `gender`, `phone_number`, `department_id`, `role_id`, `image`) VALUES
(15, 'Umar', 'Aliyu', 'Mahdi', '', '080000000', 2, 1, '61d46bb1576449.03849602.jpg'),
(20, 'Ahmad', 'Muhammad', 'Umar', 'Male', '08030303030', 1, 2, '61d46bb1576449.03849602.jpg');
...
INSERT INTO `problem_categories` (`id`, `category_description`, `department_id`) VALUES
(1, 'Tuition Fees', 3),
(2, 'Course Forms', 1),
(3, 'Exam Card', 1),
(4, 'Verification', 3),
(5, 'Personal Academic', 1),
(6, 'Hostel', 1),
(7, 'ID Card', 1);
...
(28, 'TKT624CZJ', 'testing', 'fsdasdffsdfsd', 1, 2, 3, 3, NULL, 2, NULL, '2022-02-03 22:01:24', NULL, NULL, NULL),
(30, 'TKT480OFH', 'qwmdkqw', 'q.nm,d sx', 1, 1, 6, 3, NULL, 2, NULL, '2022-02-04 01:51:08', NULL, NULL, NULL);
...
(33, 28, '2022-02-04 01:51:49', 20, 'acsx');
