                        ...
                        <form name="registration_form" id="registration_form" class="row mt-3" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="username" id="username" class="form-control form-control-sm" required>
                                    <div class="invalid-feedback">
                                            Registration number alresdy exist.
                                        </div>
                                </div>
                               <div class="row">
                                    <div class="mb-3 col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="other_name" id="other_name" class="form-control form-control-sm" style="text-transform: capitalize;">
                                </div>
