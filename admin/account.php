        ...
        <div class="card mt-4 mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div id="image_upload" class="pointer" style="background-color:red; width: 60px; height: 60px; border-radius:50%">
                        <img id="img" class="img" src="" alt="Passport" style="border-radius: 50%;">
                    </div>
                </div>
                <hr class="divider">
                <div class="row justify-content-center">
                    <div class="col-9">
                        <form id="update_form" class="row mt-3" method="post">
                            <input type="file" name="input_field" id="input_field" hidden>
                            <div class="row">
...
<script>
    ...
    function  details(id){
        ...
        xhr.onload = function(){
            ...
            if (this.status == 200) {
                ...
                document.querySelector("#img").setAttribute("src", admin.image ? "../passports/"+admin.image : "../imgs/avatar.jpeg")
    ...
    document.querySelector("#image_upload").addEventListener("click", ()=>{
        document.querySelector("#input_field").click();
    });

    document.querySelector("#input_field").addEventListener("change", ()=>{
        
        let image = document.querySelector("#input_field");

        var url = URL.createObjectURL(image.files[0]);

        let xhr = new XMLHttpRequest();
        xhr.open("POST", "../scripts/admin_image_upload.php", true);
